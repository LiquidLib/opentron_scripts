...
def run(ctx):
    ...
    tips_200 = ctx.load_labware('opentrons_flex_96_tiprack_200ul', 'D1', 'P200 TIPS')
    ...
    for i, col in enumerate(range(2, 13)):  # i goes from 0 to 10
        ...
        left_pipette.pick_up_tip(tips_200[tip_well])               # Pick up a new tip starting from A1
    ...
    for i, col in enumerate(range(2, 13)):  # i goes from 0 to 10
        ...
        left_pipette.pick_up_tip(tips_50[tip_well])               # Pick up a new tip starting from A1
